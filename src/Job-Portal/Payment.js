...
function Payment() {
    ...
    var options = {
        ...
        handler: function (response){
            ...
            axios.post("https://itwalkin-backend.onrender.com/paymentAPI/verifyPament", {response})
            .then((res)=>{
  ...
  let EmployeeId = JSON.parse(localStorage.getItem("EmpIdG"))
                 ...
                 axios.post("https://itwalkin-backend.onrender.com/paymentAPI/savePymentReciept",{amount, amountDue, amountPaid, currency, ReceiptId, EmployeeId})
                 .then((res)=>{
                    console.log(res.data)
                 })
                }else{
    ...
    rzp.open()
        ...
        async function paymentButton(amount){
            ...
            await axios.post("https://itwalkin-backend.onrender.com/paymentAPI/rzrPayment", {Amount})
            .then((res)=>{
                // console.log(res.data)
       ...
       async function PhonePepaymentButton(amount){
        await axios.post("https://itwalkin-backend.onrender.com/paymentAPI/phonePayPayment",{amount})
        .then((res)=>{
            console.log(res.data)
